...
describe('Salary Slip', () => {
  ...
  describe('monthly gross salary', () => {
    it('for an annual salary of £5,000.00', () => {
      printSalarySlip({
        id: '123',
        name: 'Jane Doe',
    ...
    it('for an annual salary of £9,060.00', () => {
      printSalarySlip({
        id: '123',
        name: 'Jane Doe',
        annualGrossSalary: 9060,
      })

      expect(console.log).toHaveBeenCalledWith('Gross Salary: £745.00')
    })
  })
})
